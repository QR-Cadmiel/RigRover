...
<body>
    ...
    <nav class="navbar">
            <ul>
                ...
                <li>
                    <a href="../noticia" id="btn-nav">Noticias</a>
                </li>
                <li>
                    <a href="../evento" id="btn-nav">Eventos</a>
                </li>
                <li>
                    <a href="../foru" id="btn-nav">Fórum</a>
                </li>
                <li>
                    <a href="../hardwar" id="btn-nav">Hardware</a>
                </li>
                <li>
                    <a href="../game" id="btn-nav">Wiki Jogos</a>
                </li>
